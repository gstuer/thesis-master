...
%Our authorization approach is inspired by the access control mechanism functional points presented by \citeauthor{Hu2014} \cite{Hu2014}.
...
\begin{description}
    ...
    Moreover, the requesting PEP may use piggybacking to send a domain-specific request with the session initialization request.
