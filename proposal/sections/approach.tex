...
\todo{Provides insecure domain-specific messages to be exchanged between two different SAS devices\dots}

\paragraph{Layer 2: Cybersecurity}
\todo{Provides authorization and access control in order to satisfy confidentiality, PoLP, and SoD.}

\paragraph{Layer 1: Cryptography}
\todo{Provides authentication via digital signatures in order to satisfy integrity, authenticity, non-repudiation, and privacy preservation.}

\paragraph{Layer 0: Message Exchange}
\todo{Provides reliable and unreliable message exchange between devices in a network.}
