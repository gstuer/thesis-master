...
In order to achieve interoperability with legacy communication systems and compatibility with different substation automation systems, the authors introduce a multimode operation design for the security filter.
...
\citeauthor{Ishchenko2018} showed that the security filter is able to meet the IEC 61850 performance requirements of GOOSE and SV using a HMAC and GMAC algorithm even on commodity of-the-shelf ARM hardware.
...
Firstly, the authors present the digital signature authentication approach prescribed by IEC 62351.
...
The approach presented by \citeauthor{Alcaraz2016} depends on the subject-role associations of RBAC for decision-making as prescribed by IEC 62351-8.
