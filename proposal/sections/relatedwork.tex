...
The authors demonstrate the delegation concept in a subscription-based remote network service environment, whereas the proposed approach uses authentication and authorization delegation in substations.
...
The approach presented by \citeauthor{Alcaraz2016} depends on the subject-role associations of RBAC for decision-making as prescribed by IEC 62351-8, whereas the proposed approach supports more fine-grained and flexible ABAC policies.
