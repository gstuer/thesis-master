...
The validity of the resulting access decision at the point of time $t$ equals the minimal validity of the attribute values in $\{\lambda_k = E_{ATT}(k, t) | k \in ATT_{auxiliary_{\rho}}\}$.
...
If multiple decisions match a data frame, a PEP may choose the decision corresponding to the most specific matching flow predicates.
