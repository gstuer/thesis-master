...
Examples of such DoS attacks in a SAS include the intentional delay of time-critical messages, also known as time-delay attacks \cite{Bianchin2018}, and flooding attacks.
...
\begin{table}
    ...
    \toprule
    \multicolumn{2}{c |}{Adversarial Attack} & \multicolumn{5}{c}{Policy}\\
    Name & Classification & I & II & III & IV & V\\
    \midrule
    % Availability
    Malware            & Availability &   & X & X &   &   \\
    Flooding           & Availability &   &   &   &   & X \\
    Time-Delay         & Availability &   &   &   & X &   \\
    % Integrity
    False Data Injection  & Integrity & X & X & X &   &   \\
    Message Forgery       & Integrity & X &   &   &   &   \\
    Message Modification  & Integrity & X &   &   &   &   \\
    Replay                & Integrity &   &   &   & X &   \\
    % Authenticity
    Spoofing / Masquerading & Authenticity & X &   &   &   &   \\
    Adaptive Chosen-Message & Authenticity & X &   &   &   &   \\
    Collusion               & Authenticity & X &   &   &   &   \\
    \bottomrule
    \end{tabular}
\end{table}
\begin{table}
