...
\autoref{sec:approach:attacks} addresses potential adversarial attacks, for which the approach must provide mitigation strategies.
...
\todo{TODO: Rewrite \& replace with paper requirements.}
...
\todo{TODO: Rewrite -> System Threats + Adversaries + Attack Trees}
\todo{TODO: Move to approach (with requirements)?}
