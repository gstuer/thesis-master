...
\todo{TODO Limitations: Clarify limitations to motivate future work. Ideas -> No intrusion detection but prevention/mitigation, might not be usable for fast messages, not every crypto for every message type, possible new attack vectors by adding new components, applicability to other ics domains, time protocol interference, physical access control}
\section{Summary}
...
\todo{TODO: Add evaluation results}