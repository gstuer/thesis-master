...
\begin{description}
    ...
    \item[RQ3] How can authentication, authorization, and access control be integrated into a malleable, scalable, and lightweight system that secures time-critical SAS communication?
\end{description}
...
\begin{itemize}
    ...
    \item Design of a certificateless attribute-based server-aided system for SAS communication security called CASC-SAS, which integrates SABAAC and CASA into a dual-path four-layered system architecture.
...
\Cref{ch:relatedwork} presents a review of the existing literature and offers a delineation between it and the proposed approach.
