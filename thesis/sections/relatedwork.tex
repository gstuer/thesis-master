...
Similar to the approach presented by \citeauthor{Ishchenko2018} \cite{Ishchenko2018}, the authors focus on Ethernet-based substation communication using the GOOSE protocol.
