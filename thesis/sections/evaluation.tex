...
In this section, an analysis of the performance aspects of our approaches CASA and SABAAC will be conducted.
...
The PAP, PSP, PDP, CAPP, and PEPs were connected to an industrial grade router from TP-Link Omada using Ethernet over twisted-pair.
...
To demonstrate the viability of our approach with regard to securing time critical message exchanges, we aimed to evaluate to what extent our approach was capable of handling different message types.
...
The procedure of the experimental latency estimation consisted of ten key events or steps.
...
\end{figure}
\todo{TODO: Present results of latency estimation}
\todo{TODO: Present results of S-CASA computation}
